    ...
    <div class="container-fluid">
      ...
      <?php if( isset($_POST['acc_num']) && $_GET['p'] == 2 ) {
               if( validAccount($_POST['acc_num']) == 0 ) { ?>
                  ...
                  <button class="btn btn-primary" onclick="document.location='deposit.php?p=1';">Back</button>
         <?php } else {
           $_SESSION['acc_num'] = $_POST['acc_num']; ?>
           <p>Enter the amount to deposit (Min $10, max $2500)</p>
           <form class="form-inline" action="deposit.php?p=3" method="POST">
            <div class="form-group">
              <label class="sr-only" for="amount">Amount</label>
              <div class="input-group">
              <div class="input-group-addon">$</div>
              <input type="number" class="form-control" min="10" step="0.01" max="2500" name="amount" placeholder="Amount" required>
              </div>
     ...
     <?php }} else if (isset($_POST['amount']) && $_GET['p'] == 3) { 
           ...
           <div class="alert alert-warning" role="alert">
              ...
              <p>Deposit Amount: <?php echo $_SESSION['amount'];?></p>
           </div>
     ...
     <?php } else { ?>
           <p>Enter the account number where you would like to deposit money.</p>
           <form action="deposit.php?p=2" method="POST">
           <div class="form-group">
